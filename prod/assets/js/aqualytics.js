...
var socket = io("http://aquathesis-bbylvs.rhcloud.com");
...
Aqualytics = {
    ...
    getLog: function(page, callback) {
        $.ajax({
            url: host + "/hydroid/backend/index.php/api/v1/device/log/" + device_id + "?page=" + page + "&offset=10",
            type: "GET",
            dataType: "JSON",
    ...
    addUser: function(params) {
        $.ajax({
            url: host + "/hydroid/backend/index.php/api/v1/user",
            type: "POST",
            data: params,
    ...
    addDevice: function(params) {
        $.ajax({
            url: "/hydroid/backend/index.php/api/v1/device",
            type: "POST",
    ...
    getUsersInfo: function() {
        $.ajax({
            url: "/hydroid/backend/index.php/api/v1/user/list",
            type: "GET",
            success: function(data) {
                window.users = data;
    ...
    getNotifications: function(callback) {
        ...
        $.ajax({
            url: host + "/hydroid/backend/index.php/api/v1/notification/user/" + id,
            type: "GET",
            success: function(result) {
